...
type AdminFeaturedWorkshopSectionHttpMethod = "GET" | "PUT";
type AdminFeaturedWorkshopSectionEndpoint = "/api/admin/featured-workshop-section";
...
async function buildForwardPayload(
  request: Request,
  method: AdminFeaturedWorkshopSectionHttpMethod,
...
export async function forwardAdminFeaturedWorkshopSectionRequest(
  request: Request,
  endpoint: AdminFeaturedWorkshopSectionEndpoint,
  method: AdminFeaturedWorkshopSectionHttpMethod,
  ...
  return NextResponse.json(
    { message: "Featured workshop section admin service is unavailable." },
    { status: 502 },
  );
}
